...
from gable.voice import quote_rail, safe, shorten
...
PHOTO_REPLACEMENT_QUESTION: Final[str] = "Can you send the correct property image?"
...
def replacement_message(finding: str) -> str:
    """Keep a visual fact bounded while preserving the complete action below it."""
    bounded_fact = shorten(finding, _PHOTO_REPLACEMENT_FACT_LIMIT)
